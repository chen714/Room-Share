...
/**
 * Created by Lorcan on 22/04/2018.
 */
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    //Identification of the geographic location of a user
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
        ...
        //Add marker to new location and pull information from Google Places API if available
        if(placeInfo != null){
            try{
